...
<?php
 if(isset($_REQUEST["sid"])){
    ...
    $qry="SELECT * FROM tbl_product where ProductId = ".$_REQUEST["sid"];
    $tbl=mysqli_query($con,$qry);
...
?>
                                ...
                                <div class="d-flex">
                                    <h4>Sub Total</h4>
                                    <div class="ml-auto font-weight-bold">Rs. <?php echo $row["Price"]; ?>/- </div>
                                </div>
                                ...
                                <div class="d-flex gr-total">
                                    <h5>Grand Total</h5>
                                    <div class="ml-auto h5"> Rs. <?php echo $row["Price"]; ?>/- 
                                     <input type="hidden"  name="hdn_Total" value="<?php echo $row["Price"]; ?>">   
                                    </div>
                                </div>
