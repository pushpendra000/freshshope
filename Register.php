...
if(isset($_POST["btn_Login"]))
{
    ...
    $qry= "SELECT * FROM  tbl_customer WHERE  Email='$email' and Password='$password' and Status='0'";
    ...
    {
        $msg_log="Invalid User Id or Password";
    }
                        ...
                        <form  method="post">
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <span style="color: red; font-weight: bold;"><?php if(isset($msg)) echo $msg?></span>
                                </div>
                            </div>
                        </form>
                    </div>
                        ...
                        <form  method="post">
                            <div class="row">
                                ...
                                <div class="submit-button text-left">
                                    ...
                                    <div id="msgSubmit" class="h3 text-center hidden"></div>
                                    <div class="clearfix"></div>
                                    <span style="color: red; font-weight: bold;"><?php if(isset($msg_log)) echo $msg_log;?></span>
                                </div>
                            </div>
                        </form>
                    </div>
