...
<?php
    if(isset($_SESSION["CustomerId"]))
    {
        $qry="SELECT tbl_orderdetails.*, ProductName FROM tbl_orderdetails, tbl_Product
         where tbl_orderdetails.ProductId = tbl_Product.ProductId and  OMID=".$_REQUEST["id"];
...
?>
                                    ...
                                    <td class="total-pr">
                                     ...
                                     <td class="total-pr">
                                        <p>Rs. <?php echo $row["Qty"] ?>/-</p>

                                       
                                    </td>
                                     <td class="total-pr">
                                        <p>Rs. <?php echo $row["Qty"]*$row["Price"] ?>/-</p>
